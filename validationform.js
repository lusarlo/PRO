...
//I decided to only include title, author, start date, pages, genre and cover as required for this validation and not all the inputs, because the user can add a book that they are still reading, since they would be able to edit content on the Bookshelf page.
